 ...
 */
class Huge_Forms_Field_Text extends Huge_Forms_Field
{
    private $limit;
    ...
    public function field_html()
    {
        ...
        <div class="hgfrm-form-field <?php echo $this->field_class();?> <?php echo $this->container_class;?>">
            ...
            <input type="text" placeholder="<?php echo $this->get_placeholder();?>" class="<?php echo $this->class;?>" name="field-<?php echo $this->id;?>" value="<?php echo $this->get_default();?>">
        </div>
        <?php
    }
