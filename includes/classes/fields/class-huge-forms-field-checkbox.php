...
/**
 * Class Huge_Forms_Field_Checkbox
 */
class Huge_Forms_Field_Checkbox extends Huge_Forms_Field
{
    /**
     ...
     *
     * @return Huge_Forms_Field_Checkbox
     * @throws Exception
     */
    ...
    public function settings_block()
    {
        ...
        $settings_block_html.='<div class="setting-row"><label>Checkbox Alignment </label><select name="optionType-'.$this->id.'" ><option value="inline" '.selected('inline',$this->option_type,false).'>Inline</option><option value="block" '.selected('block',$this->option_type,false).'>New Line</option></select></div>';
    ...
    public function field_html()
    {
        ?>
            <div class="hgfrm-form-field <?php echo $this->field_class();?> <?php echo $this->container_class;?>">
                ...
                foreach ( $options as $option){ ?>
                    <input type="checkbox" name="<?php echo $this->id;?>" value="<?php echo $option->get_value();?>">
                    <span class="<?php echo $this->container_class;?>"><?php echo $option->get_name();?></span>
                <?php } ?>
            </div>
        <?php
    }
