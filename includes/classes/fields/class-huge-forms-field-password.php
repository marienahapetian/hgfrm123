...
/**
 * Class Huge_Forms_Field_Password
 */
class Huge_Forms_Field_Password extends Huge_Forms_Field
{
     ...
     * @param int $value
     *
     * @return Huge_Forms_Field_Password
     */
    ...
    public function field_html()
    {
        ...
        <div class="hgfrm-form-field <?php echo $this->field_class();?> <?php echo $this->container_class;?>">
            ...
            <input type="password" placeholder="<?php echo $this->get_placeholder();?>" class="<?php echo $this->class;?>" name="field-<?php echo $this->id;?>" >
        </div>
        <?php
    }
