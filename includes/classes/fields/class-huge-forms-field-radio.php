...
/**
 * Class Huge_Forms_Field_Radio
 */
class Huge_Forms_Field_Radio extends Huge_Forms_Field
{
    ...
    public function settings_block()
    {
        ...
        $settings_block_html.='<div class="setting-row"><label>Radio Alignment </label><select name="optionType-'.$this->id.'" ><option value="inline" '.selected('inline',$this->option_type,false).'>Inline</option><option value="block" '.selected('block',$this->option_type,false).'>New Line</option></select></div>';
    ...
    public function field_html()
    {
        ...
        <div class="hgfrm-form-field <?php echo $this->field_class();?> <?php echo $this->container_class;?>">
            ...
            foreach ( $options as $key => $option){ ?>
                <input type="radio" <?php echo ($key==0)?'checked':'';?> name="<?php echo $this->id;?>" value="<?php echo $option->get_value();?>">
                <span class="<?php echo $this->class;?>"><?php echo $option->get_name();?></span>
            <?php } ?>
        </div>
        <?php
    }
